...
for i in range(num):
    ...
    if lst[0] == lst[1] == lst[2]:
        result.append(10000 + (lst[0] * 1000))
    elif lst[0] == lst[1] and lst[0] != lst[2]:
        result.append(1000 + (lst[0] * 100))
    elif lst[0] == lst[2] and lst[0] != lst[1]:
        result.append(1000 + (lst[0] * 100))
    elif lst[2] == lst[1] and lst[0] != lst[1]:
        result.append(1000 + (lst[1] * 100))
    else:
